...
public class EntityNukePrimed extends Entity {
    private static final DataParameter<Integer> FUSE = EntityDataManager.createKey(EntityNukePrimed.class, DataSerializers.VARINT);
    @Nullable
    ...
    private void explode() {
        float f = 4.0F;
        this.world.createExplosion(this, this.posX, this.posY + (double) (this.height / 16.0F), this.posZ, 50.0F, true);
    }
     ...
     */
    @Nullable
    public EntityLivingBase getNukePlacedBy() {
        return this.nukePlacedBy;
    }
